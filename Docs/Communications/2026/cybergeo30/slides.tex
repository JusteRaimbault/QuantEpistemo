...
%\vspace{-0.1cm}
\addtobeamertemplate{frametitle}{\hspace{-0.4cm}\includegraphics[width=1.08\textwidth]{figures/cybergeo30_template_bandeau-haut}
}{%
%\begin{textblock*}{150mm}(-1cm,-1.5cm)
%\end{textblock*}
}
...
{
\setbeamertemplate{footline}{\vspace{-2cm}\includegraphics[width=1.06\textwidth]{figures/cybergeo30_template_title_bas}}
\begin{frame}
\titlepage
\end{frame}
}
...
\setbeamertemplate{footline}{\vspace{-2cm}\hspace{-0.4cm}\includegraphics[width=1.04\textwidth]{figures/cybergeo30_template_bandeau-bas}}
...
$\rightarrow$ \textbf{Extensions en cours :} mise à jour du corpus pour les 30 ans ; projet OpenJournalScope
...
\begin{itemize}
	\item Outil OpenJournalScope permettant une exploration des corpus spatialisés, mis à jour en continu
	\item Méthodes IA pour une classification automatique des domaines de connaissance, et une explicitation de l'intégration des Model papers et Data papers au sein de la connaissance
	...
	\item Outils d'assistance à la modélisation : instances OpenMOLE
\end{itemize}
...
$\rightarrow$ Une ambition renouvelée d'une \textbf{Science Ouverte Appliquée}, par et pour les acteurs de la science
